...
public class RoundHelper {
    ...
    public void setRadius(float radiusDp) {
        ...
        float radiusPx = DensityUtil.INSTANCE.dp2px(mContext, radiusDp);
    ...
    public void setRadius(float radiusTopLeftDp, float radiusTopRightDp, float radiusBottomLeftDp, float radiusBottomRightDp) {
        ...
        mRadiusTopLeft = DensityUtil.INSTANCE.dp2px(mContext, radiusTopLeftDp);
        mRadiusTopRight = DensityUtil.INSTANCE.dp2px(mContext, radiusTopRightDp);
        mRadiusBottomLeft = DensityUtil.INSTANCE.dp2px(mContext, radiusBottomLeftDp);
        mRadiusBottomRight = DensityUtil.INSTANCE.dp2px(mContext, radiusBottomRightDp);
        if (mView != null) {
            mView.invalidate();
        }
    }
    ...
    public void setRadiusLeft(float radiusDp) {
        ...
        float radiusPx = DensityUtil.INSTANCE.dp2px(radiusDp);
        mRadiusTopLeft = radiusPx;
        mRadiusBottomLeft = radiusPx;
        if (mView != null) {
            mView.invalidate();
    ...
    public void setRadiusTopLeft(float radiusDp) {
        ...
        mRadiusTopLeft = DensityUtil.INSTANCE.dp2px(mContext, radiusDp);
        if (mView != null) {
            mView.invalidate();
        }
    }
    ...
    public void setRadiusTopRight(float radiusDp) {
        ...
        mRadiusTopRight = DensityUtil.INSTANCE.dp2px(mContext, radiusDp);
        if (mView != null) {
            mView.invalidate();
        }
    }
    ...
    public void setRadiusBottomLeft(float radiusDp) {
        ...
        mRadiusBottomLeft = DensityUtil.INSTANCE.dp2px(mContext, radiusDp);
        if (mView != null) {
            mView.invalidate();
        }
    }
    ...
    public void setRadiusBottomRight(float radiusDp) {
        ...
        mRadiusBottomRight = DensityUtil.INSTANCE.dp2px(mContext, radiusDp);
        if (mView != null) {
            mView.invalidate();
        }
    }
    ...
    public void setStrokeWidth(float widthDp) {
        ...
        mStrokeWidth = DensityUtil.INSTANCE.dp2px(mContext, widthDp);
        if (mView != null) {
            setRadius();
