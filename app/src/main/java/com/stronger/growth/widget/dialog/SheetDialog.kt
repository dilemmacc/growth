...
class SheetDialog(private val context: Context) : BottomDialog(context = context) {
    ...
    //cancel 的样式
    private val bgCancel = R.drawable.bg_dialog_cancel

    //当item 多个的时候  中间item的样式
    private val bgMultipleCenter = R.drawable.bg_dialog_item_center

    //当 item 只有一个的时候  item  样式
    private val bgSingleCenter = R.drawable.bg_dialog_item_single

    //当item 多个的时候 最下面的一个item 样式
    private val bgMultipleBottom = R.drawable.bg_dialog_single

    //当item 多个的时候 最上面的一个item 样式
    private val bgMultipleTop = R.drawable.bg_dialog_top

    //title 的样式
    private val bgTitle = R.drawable.bg_dialog_top
    ...
    override fun getLayoutId(): Int {
        return R.layout.dialog_actionsheet
    }
